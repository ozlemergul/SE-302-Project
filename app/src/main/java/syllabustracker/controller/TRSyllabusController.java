...
public class TRSyllabusController implements PageController, Initializable {
    ...
    private String[] Semester = {"Güz", "Bahar", "Güz/Bahar" };
    private String[] CourseLanguage = {"İngilizce", "Türkçe", "İkinci Yabancı Dil"};
    private String[] CourseType = {"Zorunlu", "Seçmeli"};
    private String[] CourseLevel = {"Ön Lisans", "Lisans", "Yüksek Lisans", "Doktora"};
